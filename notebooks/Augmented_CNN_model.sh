...
echo "/sailhome/${USER}/scaling-kilns/kiln-scaling/notebooks/Augmented_CNN_model.py"
python /sailhome/${USER}/scaling-kilns/kiln-scaling/notebooks/Augmented_CNN_model.py $USER > ${logfile}
